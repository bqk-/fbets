        ...
        for($i=1;$i<=$this->nb_journees;$i++){
            ...
            foreach ($jours as $content) {
                ...
                foreach ($matchs as $match) {
                    ...
                    preg_match('#<div class="equipeDom"><img src="([a-zA-Z0-9-\./\?:]+)" alt="([\p{L&}0-9 \'-]+)">#', html_entity_decode($match, ENT_COMPAT, 'ISO-8859-1'),$domicile);
                    preg_match('#<div class="equipeExt"><img src="([a-zA-Z0-9-\./\?:]+)" alt="([\p{L&}0-9 \'-]+)">#', html_entity_decode($match, ENT_COMPAT, 'ISO-8859-1'),$exterieur);
